...
%While these operations are important The content of sources can change dynamically and the solution of source selection can change over time~\cite{rekatsinas:2014}, thus,  so the quality appraisal needs to be repeated. Point about repeated operations.
